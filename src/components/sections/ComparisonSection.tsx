...
const ROWS = [
  ...
  { item: "방문 견적 속도",               others: "수일 소요",                    us: "24시간 내 현장 방문" },
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div {...fadeInTable} className={`max-w-3xl mx-auto rounded-xl overflow-hidden border border-neutral-200 shadow-sm ${fadeInTable.className}`}>
          ...
          {ROWS.map((row, i) => (
            <div
              key={i}
              className={`grid grid-cols-[1fr_1fr_1fr] text-[13px] leading-snug border-t border-neutral-100 ${i % 2 === 0 ? "bg-white" : "bg-neutral-50/60"}`}
            >
        ...
        <div {...fadeInCta} className={`mt-8 text-center ${fadeInCta.className}`}>
          <p className="text-neutral-500 text-sm mb-4">
            지금 신청하시면 <span className="font-semibold text-primary">24시간 내</span>에 담당자가 연락드립니다.
          </p>
          <Link
