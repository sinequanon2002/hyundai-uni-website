...
export const metadata: Metadata = {
  title: "지정폐기물이란? 정의·분류·관리 기준 | 현대유앤아이",
  description:
    "지정폐기물의 법적 정의(폐기물관리법 제2조 제4호), 일반폐기물과의 차이, 올바로시스템 의무, 배출자 연대 책임까지 전문가가 정리한 완전 가이드입니다.",
};
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "지정폐기물이란 사업장폐기물 중에서 폐유·폐산 등 주변 환경을 오염시킬 수 있거나 인체에 위해를 줄 수 있는 유해물질을 포함한 폐기물로, 「폐기물관리법」 제2조 제4호 및 시행령 제3조에서 규정합니다.",
      },
    },
    {
      "@type": "Question",
      name: "지정폐기물은 일반폐기물과 어떻게 다른가요?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "지정폐기물은 일반폐기물과 달리 가장 엄격한 환경 기준이 적용되며, 안정화·고형화·차단형 매립 등 특수 처분 기술이 필요합니다. 위반 시 즉각적인 영업정지와 높은 수준의 벌금·형사처벌을 받으며, 올바로시스템을 통한 실시간 전자인계서 작성이 의무입니다.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "올바로시스템은 한국환경공단이 운영하는 폐기물 전자인계관리 시스템으로, 지정폐기물의 발생·운반·처리 전 과정을 실시간으로 추적합니다. 지정폐기물 배출자는 배출 전 반드시 올바로시스템에 전자인계서(확정 또는 예약)를 작성해야 합니다.",
      },
    },
    {
      "@type": "Question",
      name: "지정폐기물을 위탁 처리해도 배출자 책임이 남나요?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "네. 「폐기물관리법」에 따라 허가된 처리업자에게 위탁한 이후에도 부적정 처리 여부에 따라 배출자가 연대 책임을 질 수 있습니다. 따라서 환경부 허가를 받은 신뢰할 수 있는 수집·운반·처리 업체를 선정하는 것이 필수입니다.",
      },
    },
  ],
};
  ...
  return (
    <>
      ...
      <div className="max-w-5xl mx-auto px-4 py-12 md:py-20 animate-fade-in-up">
        ...
        <ContentMeta
          reviewDate="2026-05"
          legalBasis="폐기물관리법 제2조 제4호 · 시행령 제3조"
        />
      </div>
    </>
  );
