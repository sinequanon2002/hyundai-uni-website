      ...
      <>
        ...
        <div className="max-w-3xl mx-auto px-4 py-10">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-lg font-bold text-navy-900">나의 문의 내역</h2>
            <Link
              href="/my/inquiries"
          ...
          {inquiries.length === 0 ? (
            <div className="bg-white rounded-xl border border-slate-200 shadow-sm py-14 text-center">
              ...
              <Link
                ...
                className="inline-block mt-4 px-5 py-2.5 rounded-lg bg-mint-500 text-white text-sm font-medium hover:bg-mint-600 transition-colors"
              >
                견적 문의하기
              </Link>
            </div>
          ...
          <div className="mt-6 text-center">
            <Link
              href="/support/inquiry"
              className="inline-block px-5 py-2.5 rounded-lg bg-mint-500 text-white text-sm font-medium hover:bg-mint-600 transition-colors"
            >
              새 견적 문의하기
            </Link>
          </div>
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 space-y-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-4">
            ...
            <div className="flex gap-2 sm:flex-col sm:gap-2 shrink-0">
              <Link
                ...
                className="flex-1 sm:flex-none text-center px-5 py-2.5 rounded-lg bg-mint-500 text-white text-sm font-semibold hover:bg-mint-600 transition-colors"
              >
                로그인
              </Link>
              <Link
                href="/register"
                className="flex-1 sm:flex-none text-center px-5 py-2.5 rounded-lg border border-cobalt-600 text-cobalt-600 text-sm font-semibold hover:bg-cobalt-50/50 transition-colors"
              >
                회원가입
              </Link>
            </div>
        ...
        <p className="text-center text-sm text-slate-500">
          새로운 견적이 필요하신가요?{" "}
          <Link href="/support/inquiry" className="text-cobalt-600 font-medium hover:underline">
            견적 문의하기 →
          </Link>
        </p>
      </div>
