        ...
        <div className="container mx-auto px-4 md:px-8 max-w-5xl">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-start">
            ...
            <div className="space-y-5">
              <h2 className="text-lg font-bold text-neutral-900">체크리스트 포함 항목</h2>
              {CHECKLIST_ITEMS.map((section) => (
                <div key={section.category} className="bg-white rounded-xl border border-neutral-100 shadow-sm p-5">
                  ...
                  <ul className="space-y-2">
                    {section.items.map((item) => (
                      <li key={item} className="flex items-center gap-2.5 text-sm text-neutral-600">
                        <div className="w-4 h-4 rounded border-2 border-neutral-300 shrink-0" />
                        {item}
                      </li>
                    ))}
                  </ul>
            ...
            <div>
              {submitted ? (
                <div className="bg-white rounded-2xl shadow-md border border-neutral-100 p-8 text-center">
                  ...
                  <div className="bg-neutral-light rounded-xl p-4 text-sm text-neutral-600 space-y-1.5">
                ...
                <div className="bg-white rounded-2xl shadow-md border border-neutral-100 p-8 sticky top-28">
                  <div className="flex items-center gap-3 mb-2">
                    <div className="w-10 h-10 bg-accent/10 rounded-xl flex items-center justify-center">
                      <Download size={20} className="text-accent" />
                    </div>
                    <div>
                      <h2 className="text-lg font-bold text-neutral-900">무료 체크리스트 받기</h2>
                      <p className="text-xs text-accent font-medium">PDF 1장 · 바로 활용 가능</p>
                    </div>
                  </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-10 pr-4 py-3 border border-neutral-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-accent/30 focus:border-accent transition"
                        />
                      </div>
                    </div>
                    ...
                    <button
                      type="submit"
                      className="w-full flex items-center justify-center gap-2 py-3.5 bg-accent text-white rounded-xl font-bold text-sm hover:bg-accent/90 transition-colors shadow-md shadow-accent/20"
                    >
                      <Download size={16} />
                      올바로시스템 체크리스트 받기
                    </button>
                  ...
                  <div className="mt-6 pt-5 border-t border-neutral-100">
                    <p className="text-xs text-neutral-500 font-medium mb-2">이런 분께 추천합니다</p>
                    <ul className="space-y-1.5">
                      {[
                        ...
                        <li key={item} className="text-xs text-neutral-500 flex items-start gap-1.5">
